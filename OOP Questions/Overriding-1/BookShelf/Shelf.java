...
import OOP.Passing_Object_To_method.Light;
...
public class Shelf  {
    ...
    public static void removeBook(int id) {
        theBooks.removeIf(eachBook -> eachBook.getId()==id);
    }
    ...
    public static void removeBook(String author) {
        theBooks.removeIf(eachBook -> eachBook.getAuthor().equals(author));
    }
